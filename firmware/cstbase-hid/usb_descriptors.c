...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x27B8,                 // Vendor ID: ThingM
    0xC570,                 // Product ID: CST Base
...
ROM BYTE configDescriptor1[]={
    ...
    DSC_HID,                // HID descriptor type    //0x11,0x01,                 // HID Spec Release Number in BCD format (1.11)
    ...
    // FIXME: this is unneeded for our protocol, but just commenting it out seems to cause problems
    /* Endpoint Descriptor */
    0x07,//sizeof(USB_EP_DSC)
    USB_DESCRIPTOR_ENDPOINT,    //Endpoint Descriptor
...
// size: 2 + 2*8 = 18 bytes long
// the "@ 0x1fe0 puts it at the top 32-bytes of the flash space
ROM struct{BYTE bLength;BYTE bDscType;WORD string[8];}sd003 @ 0x1fe0 =
{
